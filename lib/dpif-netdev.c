...
dpif_netdev_execute(struct dpif *dpif, const struct dpif_execute *execute)
{
    ...
    //printf("Extracting flow\n");
    flow_extract(&copy, 0, 0, NULL, -1, &key);
    //printf("Flow extracted\n");
                         ...
                         int queue_no, const struct flow *flow, uint64_t arg)
{
    ...
    //printf("packet allocated = %u\n", (unsigned int)packet->allocated);
                          ...
                          size_t actions_len)
{
    ...
    NL_ATTR_FOR_EACH_UNSAFE (a, left, actions, actions_len) {
        ...
        case OVS_ACTION_ATTR_OUTPUT:
            //printf("Case : output! Calling netdev_output_port\n");
            dp_netdev_output_port(dp, packet, nl_attr_get_u32(a));
            break;

        case OVS_ACTION_ATTR_USERSPACE:
            //printf("Case : userspace! Calling netdev_action_userspace\n");
